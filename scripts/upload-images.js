...
const SUPABASE_KEY = process.env.NEXT_PUBLIC_SUPABASE_SERVICE_ROLE_KEY; // service role required for server uploads
const SUPABASE_BUCKET = process.env.SUPABASE_BUCKET || 'manga-images';

if (!SUPABASE_URL || !SUPABASE_KEY) fatal('Please set NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_SERVICE_ROLE_KEY environment variables');
